...
public class usuarioController {
    ...
    public void setImgUsuario(String ruta){
        FuncionesReutilizables.ajustarImagenes(ruta,imgUsuario, TamanoImagenes.ANCHURAIMAGENGRANDEUSUARIO,TamanoImagenes.ALTURAIMAGENGRANDEUSUARIO);
    }
    public void setImgGuardar(String ruta){
    ...
    public void setImgCancelar(String ruta){
